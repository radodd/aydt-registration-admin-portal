      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          <Link
            ...
            className="inline-flex items-center px-4 py-2 text-sm font-medium rounded-xl border border-neutral-300 bg-white text-neutral-700 hover:bg-neutral-50 transition"
          >
            Dashboard
          </Link>
          <Link
