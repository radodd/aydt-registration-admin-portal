    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/40">
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-2xl overflow-hidden">
        ...
        <div className="flex gap-0 divide-x divide-neutral-100">
              ...
              <div className="grid grid-cols-2 gap-3 pt-1">
                <div className="col-span-2">
                  ...
                  <select
                    ...
                    className="w-full px-3 py-2 border border-neutral-200 rounded-lg text-sm bg-white focus:outline-none focus:ring-2 focus:ring-blue-500"
                  >
          ...
          {/* Right — family info */}
          <div className="w-52 shrink-0 p-5 bg-neutral-50">
        ...
        <div className="flex items-center justify-end gap-3 px-6 py-4 border-t border-neutral-200">
          <button
            onClick={onClose}
            className="px-4 py-2 text-sm text-slate-600 border border-neutral-200 rounded-lg hover:bg-neutral-50 transition"
          >
            Cancel
          </button>
          <button
                    ...
                    <div className="border border-neutral-200 rounded-xl overflow-hidden">
                      {familyResults.map((f) => (
                        <button
                          ...
                          className="flex items-center gap-3 w-full px-4 py-3 text-left hover:bg-neutral-50 border-b border-neutral-100 last:border-0 transition"
                        >
              ...
              <div className="flex gap-2">
                <button
                  ...
                  className={`px-3 py-1.5 rounded-lg text-sm font-medium transition ${
                    familyMode === "new"
                      ? "bg-lavender/20 text-lavender-text"
                        ...
                        <div className="border border-neutral-200 rounded-lg overflow-hidden">
                          {famResults.map((f) => (
                            <button
                              ...
                              className="flex items-center justify-between w-full px-3 py-2 text-left text-sm hover:bg-neutral-50 border-b border-neutral-100 last:border-0"
                            >
