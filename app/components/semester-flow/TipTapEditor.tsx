...
const BANNER_HEIGHTS: { label: string; key: string; px: number }[] = [
  { label: "S", key: "small", px: 160 },
  { label: "M", key: "medium", px: 240 },
  { label: "L", key: "large", px: 320 },
];
...
export default function TipTapEditor({
  ...
  const [imageModalLayout, setImageModalLayout] = useState<ImageLayout>("inline");
  ...
  const isBannerSelected =
    selectedImageAttrs?.layout === "banner";
  ...
  return (
    <>
      ...
      <div className="border border-gray-300 rounded-xl overflow-hidden focus-within:ring-2 focus-within:ring-indigo-500">
        ...
        {/* Editor content */}
        <div className="px-4 py-3 prose prose-sm max-w-none text-slate-600 bg-white">
